<div class="container-fluid px-4">
    ...
    @if ($editID)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <select class="form-select" wire:model="P_Id.{{ $index }}"
                                            id="P_Id.{{ $index }}" style="width: 200px;">
        ...
        @elseif ($planType == 'regular')
            <form wire:submit.prevent="acceptActionPlan({{ $editID }})">
                @csrf
                <div style="display: flex; justify-content: space-between;">
                    <a class="btn btn-outline-primary "
                        href="{{ route('detail_action_plan', ['id' => $editID]) }}">ย้อนกลับ</a>
                        ...
                        <td>
                            <div style="display: flex; align-items: center; white-space: nowrap;">
                                ...
                                <input class="form-control @error('project_name') is-invalid @enderror"
                                    type="text" autocomplete="off" placeholder="ชื่อโครงการ"
                                    wire:model="project_name" id="project_name" required>
                            </div>
