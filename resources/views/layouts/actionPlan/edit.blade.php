    ...
    <form wire:submit.prevent="nextCreatePage2()">
                ...
                <td>
                    <div style="display: flex; align-items: center; white-space: nowrap;">
                        ...
                        <input class="form-control @error('project_name') is-invalid @enderror" type="text"
                            autocomplete="off" placeholder="ชื่อโครงการ" wire:model="project_name" id="project_name">
                    </div>
        ...
        <table class="table-sm" style="width: 100%;">
            ...
            <tr>
                <th>ยุทธศาสตร์ </th>
                <td>
                    <select class="form-select @error('SI_ID') is-invalid @enderror" wire:model="SI_ID" id="SI_ID"
                        style="width: 50%;">
                        <option value="" selected>เลือก</option>
                        <option value="" disabled>-------------------------</option>
