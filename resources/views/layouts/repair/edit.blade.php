                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3">
                                ...
                                <select class="form-select @error('budget') is-invalid @enderror"
                                    wire:model.defer="budget" id="budget" style="width: 100%;" aria-labelledby="budget">
                                    @php
                                        $currentYear = date('Y');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                                ...
                                <input class="form-control @error('quant') is-invalid @enderror"
                                    wire:model.defer="quant" min="1" id="quant" type="number"
                                    style="width: 100%;" autocomplete="off" aria-labelledby="quant">
                                @error('quant')
