                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input class="form-control @error('description') is-invalid @enderror" type="text"
                                ...
                                wire:change="updateFieldsFromDescription" aria-labelledby="description">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control @error('quant') is-invalid @enderror" wire:model.defer="quant"
                                min="1" id="quant" type="number" style="width: 100%;" autocomplete="off"
                                aria-labelledby="quant">
                            @error('quant')
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control @error('package') is-invalid @enderror"
                                wire:model.defer="package" id="package" type="text" style="width: 100%;" maxlength="250"
                                autocomplete="off" placeholder="หน่วย" aria-labelledby="package">
                            @error('package')
                        ...
                        <div class="col-md-3">
                            ...
                            <textarea class="form-control @error('reason') is-invalid @enderror"
                                wire:model.defer="reason" id="reason" style="width: 100%;" col-md-3s="50" rows="2"
                                maxlength="250" autocomplete="off" placeholder="เหตุผลและความจำเป็น"
                                aria-labelledby="reason"></textarea>
                            @error('reason')
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" wire:model.defer="remark" id="remark" type="text"
                                style="width: 100%;" maxlength="250" autocomplete="off" placeholder="หมายเหตุ(ถ้ามี)"
                                aria-labelledby="remark">
                        </div>
                    </div>
                </div>
