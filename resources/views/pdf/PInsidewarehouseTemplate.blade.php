...
<body>
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            <td width="50px"></td>
            <td width="5px">2.</td>
            <td style="word-break: keep-all; text-align: justify; word-spacing: -0.2px">
                    ...
                    @foreach ($equipments as $key => $equipment)
                        <tr>
                            ...
                            <td style="text-align: justify; word-spacing: -0.3px">
                                {{ $count++ }}. {{ $equipment['Equip_NAME'] }} จำนวน
                                {{ number_format($equipment['Equip_AMOUNT'], 0) }}x{{ number_format($equipment['Equip_CURRENT_PRICE'], 0) }}
                                เป็นเงิน
                                {{ number_format($equipment['Equip_AMOUNT'] * $equipment['Equip_CURRENT_PRICE'], 0) }}
                                บาท
                            </td>
                        </tr>
                    @endforeach
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            ...
            <td width="5px">4.</td>
            <td>
                วงเงินที่จะซื้อ/จ้าง {{ number_format(round($Remaining_Price, 2), 0) }} บาท
