        ...
        <tr>
            <td class="textecho">
                ...
                @if (strlen($department) > 30 && strlen($department) <= 80)
                    {{ $department }} ได้รับอนุมัติให้ดำเนินการตามแผนเงินบำรุง/งบประมาณ <br>
                ...
                <table width="100%" border="0" style="vertical-align: top;">
                    <tr>
                        ...
                        <td class="textecho">
                            ...
                            @endphp
                            @if ($id > 0)
                                {{ $count }}. {{ $projectName }} ราคา
                                {{ $quant }}x{{ number_format($price) }} บาท
                                {{-- เป็นเงิน                {{ number_format($totalPrice) }} บาท --}}
                                <br>
                                @php
                                    $count++;
                                @endphp
