...
<body>
                    ...
                    @foreach ($equipments as $key => $equipment)
                        <tr>
                            ...
                            <td style="text-align: justify; word-spacing: -0.3px">
                                ...
                                {{ number_format($equipment['Equip_AMOUNT'], 0) }}x
                                {{ number_format(round($equipment['Equip_CURRENT_PRICE'], 2), 2) }}
                                บาท
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            ...
            <td width="5px">4.</td>
            <td>
                วงเงินที่จะซื้อ/จ้าง {{ number_format(round($Remaining_Price, 2), 2) }}
                บาท ({{ $Remaining_Price_Text }})
            </td>
        </tr>
    </table>
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
