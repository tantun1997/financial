<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><i class="fa-solid fa-inbox "></i> เพิ่มแผนงานจ้างเหมาบริการ</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a href="{{ route('contract_services') }}">แผนฯจ้างเหมาบริการ</a>
        </li>
        <li class="breadcrumb-item active">
            เพิ่มแผนงานจ้างเหมาบริการ</li>
    </ol>
    <hr>
    <form wire:submit.prevent="addContract()">
        @csrf
        <div class="card">
            <h5 class="card-header">เพิ่มแผนงานจ้างเหมาบริการ</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <!-- รหัส ปีงบประมาณ -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control @error('description') is-invalid @enderror" type="text"
                            wire:model="description" id="description" list="listDescription" autocomplete="off"
        ...
        <div class="mt-4" style="text-align: center ">
            <a class="btn btn-danger" href="{{ route('contract_services') }}" role="button">ยกเลิก</a>
