<div class="container-fluid px-4">
    ...
    <h3 class="mt-3 mb-3"><i class="fa-duotone fa-newspaper"></i> ข้อมูลแผนฯสอบเทียบเครื่องมือ</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a
                href="\">แผนการจัดซื้อจัดจ้าง วัสดุ/ครุภัณฑ์</a></li>
        <li class="breadcrumb-item active">
                ข้อมูลแผนฯสอบเทียบเครื่องมือ</li>
    </ol>
    <hr>
    <div class="mb-3">
        ...
        {{-- @if ($item->status == 'on') --}}
        <a class="btn btn-outline-primary" href="{{ route('creat_calibration') }}"
            role="button">สร้างแผนฯสอบเทียบเครื่องมือ</a>
        {{-- @endif
        @endforeach --}}
    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="table-cell" style="text-align: right;">
                                        <a class="btn btn-outline-primary btn-sm"
                                            href="{{ route('detail_calibration', ['id' => $query->id]) }}">ดูข้อมูล</a>
        ...
        function initializeDataTable() {
            table = $('#dataTable').DataTable({
                ...
                buttons: [{
                    ...
                    filename: 'บันทึกแผนฯจ้างเหมาบริการ',
