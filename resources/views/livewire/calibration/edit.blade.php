<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
        ...
        </svg> รายละเอียดแผนสอบเทียบเครื่องมือ</h3>
        ...
        <div class="col-lg-4">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                    ...
                    <div style="display: flex; align-items: center;">
                        <a class="btn btn-outline-danger"
                            href="http://192.168.2.142/calibration/detail?id={{ $Plan_ID }}">ยกเลิก</a>
            ...
            <div class="card mb-3">
                <h5 class="card-header" style="background-color: rgb(24, 138, 245);color: white"><i
                        class="far fa-edit"></i>
                    ข้อมูลแผนสอบเทียบเครื่องมือ</h5>
                @if ($edit_plan)
                    <div class="card-body">
                                        ...
                                        @if ($Equip_ID == $query->Equip_ID)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <small>
                                                        <textarea class="form-control mb-2" wire:model="Equip_NAME" rows="2"></textarea>
    ...
    <script>
        function generatePdf(id) {
            ...
            if ({{ $EQUIPMENT_PLAN->Plan_LEVEL }} == 2) {
                ...
                // แสดง Alert ให้ผู้ใช้เลือก
                toastr.error('เพิ่มการสอบเทียบเครื่องมือก่อน');
            } else if ({{ $EQUIPMENT_PLAN->Checked_use }} == 0) {

                // แสดง Alert ให้ผู้ใช้เลือก
                toastr.error('เลือกรายการสอบเทียบเครื่องมือ');
            } else {

                // เปิดหน้าต่างใหม่เพื่อสร้าง PDF
                window.open('/CalibrationPDF/' + id, '_blank');
