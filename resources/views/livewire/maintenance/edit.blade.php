<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><i class="fa-solid fa-inbox "></i> ข้อมูลแผนงานบำรุงรักษา</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a href="{{ route('maintenance_equip') }}">แผนฯบำรุงรักษา</a>
        </li>
        <li class="breadcrumb-item active">
            ข้อมูลแผนงานบำรุงรักษา</li>
    </ol>
    <hr>
    ...
    @if ($editDetail)
        ...
        <div class="card">
            <h5 class="card-header">แก้ไขแผนงานบำรุงรักษา</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <!-- รหัส ปีงบประมาณ -->
        ...
        <div class="mt-4" style="text-align: center ">
            <a class="btn btn-outline-danger "
                href="{{ route('detail_maintenance', ['id' => $edit_id]) }}">ย้อนกลับ</a>
