<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
        ...
        </svg> รายละเอียดแผนบำรุงรักษา</h3>
    <hr>
    @if ($show_equip)
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <div>
                <a class="btn btn-outline-primary"
                    href="http://192.168.2.142/maintenance_equip/detail?id={{ $Plan_ID }}">ย้อนกลับ</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-7">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="btn btn-outline-danger btn-sm"
                                                        href="http://192.168.2.142/maintenance_equip/detail?id={{ $Plan_ID }}">ยกเลิก</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
                                    ...
                                    <tbody>
                                        @foreach ($VW_EQUIPMENT as $query)
                                            <tr>
                                                ...
                                                <td style="text-align: left; white-space: nowrap; width: 60%">
                                                    หมายเลข: {{ $query->EQUP_ID }} <br>
                                                    ชื่อรายการ: {{ $query->EQUP_NAME }} <br>
                                                    ราคา: {{ number_format($query->EQUP_PRICE) }} บาท
                                                </td>
                                                <td style="text-align: left;">
                                                    แผนก: {{ $query->TCHN_LOCAT_NAME }}<br>
                                                    อายุการใช้งาน: {{ number_format($query->age) }} ปี
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
            ...
            <div class="col-lg-4">
                @if ($edit_plan)
                    <div
                        ...
                        <div>
                            <a class="btn btn-outline-primary" href="{{ route('maintenance_equip') }}">ย้อนกลับ</a>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped table-sm" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="form-text" style="text-align: center">จำนวนครุภัณฑ์</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center">
    ...
    <script>
        function generatePdf(id) {
            ...
            if ({{ $EQUIPMENT_PLAN->Plan_LEVEL }} == 2) {
                ...
                // แสดง Alert ให้ผู้ใช้เลือก
                toastr.error('เพิ่มครุภัณฑ์ก่อน จะสามารถกดแก้ไขและใส่ราคาได้');
                ...
                window.open('/MaintenancePDF/' + id, '_blank');
