<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><i class="fa-solid fa-inbox "></i> เพิ่มแผนงานซ่อม</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a href="{{ route('repair_equip') }}">แผนงานซ่อม</a>
        </li>
        <li class="breadcrumb-item active">
            เพิ่มแผนงานซ่อม</li>
    </ol>
    <hr>
    <form wire:submit.prevent="addRepair()">
        @csrf
        <div class="card">
            <h5 class="card-header">เพิ่มแผนงานซ่อม</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <!-- รหัส ปีงบประมาณ -->
        ...
        <div class="mt-4" style="text-align: center ">
            <a class="btn btn-danger" href="{{ route('repair_equip') }}" role="button">ยกเลิก</a>
