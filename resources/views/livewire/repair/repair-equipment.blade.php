<div class="container-fluid px-4">
    ...
    <h3 class="mt-3 mb-3"><i class="fa-duotone fa-newspaper"></i> ข้อมูลแผนงานซ่อม</h3>
    ...
    <div class="mb-3">
        @foreach ($close_plan as $item)
            ...
            @if ($item->status == 'on')
                <a class="btn btn-outline-primary" href="{{ route('creat_repair') }}" role="button">สร้างแผนงานซ่อม</a>
            @endif
        @endforeach
    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="table-cell" style="text-align: right;">
                                        <a class="btn btn-outline-primary btn-sm"
                                            href="{{ route('detail_repair', ['id' => $query->id]) }}">ดูข้อมูล</a>
