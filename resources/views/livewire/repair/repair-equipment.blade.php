<div class="container-fluid">
    ...
    <div class="mb-3">
        @foreach ($close_plan as $item)
            ...
            @if ($item->status == 'on')
                <a class="btn btn-outline-primary" href="{{ route('creat_repair') }}" role="button">+
                    เพิ่มแผนงานซ่อม</a>
            @endif
        @endforeach
    </div>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; text-align: center;">
                                <a class="btn btn-outline-primary btn-sm"
                                    href="http://192.168.2.142/repair_equip/detail?id={{ $item->Plan_ID }}">ดูข้อมูล</a>
