        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <div>
                <a class="btn btn-outline-primary"
                    href="http://192.168.2.142/repair_equip/detail?id={{ $Plan_ID }}">ย้อนกลับ</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-7">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="btn btn-outline-danger btn-sm"
                                                        href="http://192.168.2.142/repair_equip/detail?id={{ $Plan_ID }}">ยกเลิก</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
    ...
    <script>
        function generatePdf(id) {
            ...
            if ({{ $EQUIPMENT_PLAN->Plan_LEVEL }} == 2) {
                ...
                window.open('/RepairPDF/' + id, '_blank');
