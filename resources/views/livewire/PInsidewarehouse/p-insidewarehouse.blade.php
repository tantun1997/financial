<div class="container-fluid">
    <h3 class="mt-3 mb-3"> ข้อมูลแผนวัสดุในคลัง</h3>
    <div class="mb-3">
        @foreach ($close_plan as $item)
            ...
            @if ($item->status == 'on')
                <a class="btn btn-outline-primary" href="{{ route('creat_insidewarehouse_plan') }}" role="button">+
                    เพิ่มแผนวัสดุในคลัง</a>
            @endif
        @endforeach
    </div>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; text-align: center;">
                                <a class="btn btn-outline-primary btn-sm"
                                    href="http://192.168.2.142/PInsidewarehouse/detail?id={{ $item->Plan_ID }}">ดูข้อมูล</a>
