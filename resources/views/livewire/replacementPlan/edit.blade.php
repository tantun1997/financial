<div class="container-fluid px-4">
    <h3 class="mt-3 mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
            style="fill: rgb(160, 80, 235);">
            <path d="m18.988 2.012 3 3L19.701 7.3l-3-3zM8 16h3l7.287-7.287-3-3L8 13z"></path>
            <path
                d="M19 19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .896-2 2v14c0 1.104.897 2 2 2h14a2 2 0 0 0 2-2v-8.668l-2 2V19z">
            </path>
        </svg> รายละเอียดแผนทดแทน</h3>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <div>
                <a class="btn btn-outline-primary"
                    href="http://192.168.2.142/replacement_plan/detail?id={{ $Plan_ID }}">ย้อนกลับ</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-7">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="btn btn-outline-danger btn-sm"
                                                        href="http://192.168.2.142/replacement_plan/detail?id={{ $Plan_ID }}">ยกเลิก</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
            ...
            <div class="col-lg-4">
                @if ($edit_plan)
                    <div
                        ...
                        <div>
                            <a class="btn btn-outline-primary" href="{{ route('replacement_plan') }}">ย้อนกลับ</a>
                        </div>
    ...
    <script>
        function generatePdf(id) {
            ...
            if ({{ $EQUIPMENT_PLAN->Plan_LEVEL }} == 2) {
                ...
                window.open('/ReplacementPDF/' + id, '_blank');
