<div class="container-fluid">
    <h3 class="mt-3 mb-3"> <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
        ...
        </svg> ข้อมูลแผนไม่มีเลขครุภัณฑ์</h3>
    ...
    <div class="mb-3">
        @foreach ($close_plan as $item)
            ...
            @if ($item->status == 'on')
                <a class="btn btn-outline-primary" href="{{ route('creat_noserial_plan') }}" role="button">+
                    เพิ่มแผนไม่มีเลขครุภัณฑ์</a>
            @endif
        @endforeach
    </div>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; text-align: center;">
                                <a class="btn btn-outline-primary btn-sm"
                                    href="http://192.168.2.142/noserial_plan/detail?id={{ $item->Plan_ID }}">ดูข้อมูล</a>
        ...
        function initializeDataTable() {
            table = $('#dataTable').DataTable({
                ...
                buttons: [{
                    ...
                    filename: 'บันทึกแผนฯไม่มีเลขครุภัณฑ์',
                    title: `รายงานแผนฯไม่มีเลขครุภัณฑ์ หน่วยบริการโรงพยาบาลสมเด็จพระพุทธเลิศหล้า`,
                    autoFilter: true,
                    exportOptions: {
