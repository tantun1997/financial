<div class="container-fluid px-4">
    ...
    <h3 class="mt-3 mb-3"><i class="fa-duotone fa-newspaper"></i> ข้อมูลแผนฯจัดซื้อครุภัณฑ์</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item "><a
                href="\">แผนการจัดซื้อจัดจ้าง วัสดุ/ครุภัณฑ์</a></li>
        <li class="breadcrumb-item active">
                ข้อมูลแผนฯจัดซื้อครุภัณฑ์</li>
    </ol>
    <hr>
    <div class="mb-3">
        ...
        {{-- @if ($item->status == 'on') --}}
        <a class="btn btn-outline-primary" href="{{ route('creat_purchasing_plan') }}"
            role="button">สร้างแผนฯจัดซื้อครุภัณฑ์</a>
        {{-- @endif
        @endforeach --}}
    </div>
                ...
                <table id='dataTable' class="table table-bordered table-hover table-sm" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">จัดการ</th><!-- 14 -->
                        ...
                        @foreach ($replace_increase_equip as $query)
                            @if ($query->TCHN_LOCAT_ID == Auth::user()->deptId || Auth::user()->isAdmin == 'Y')
                                <tr style="cursor: pointer;">
                                    ...
                                    <td class="table-cell" style="text-align: right;">
                                        {{ number_format(round($query->price * $query->qty, 2), 2) }}</td>
                                    ...
                                    <td class="table-cell" style="text-align: right;">
                                        <a class="btn btn-outline-primary btn-sm"
                                            href="{{ route('detail_purchasing_plan', ['id' => $query->id]) }}">ดูข้อมูล</a>
