<div class="container-fluid">
    ...
    <div class="mb-3">
        @foreach ($close_plan as $item)
            ...
            @if ($item->status == 'on')
                <a class="btn btn-outline-primary" href="{{ route('creat_potential_plan') }}" role="button">+
                    เพิ่มแผนเพิ่มศักยภาพ</a>
            @endif
        @endforeach
    </div>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; text-align: center;">
                                <a class="btn btn-outline-primary btn-sm"
                                    href="http://192.168.2.142/potential_plan/detail?id={{ $item->Plan_ID }}">ดูข้อมูล</a>
        ...
        function initializeDataTable() {
            table = $('#dataTable').DataTable({
                ...
                buttons: [{
                    ...
                    filename: 'บันทึกแผนฯเพิ่มศักยภาพ',
                    title: `รายงานแผนฯเพิ่มศักยภาพ หน่วยบริการโรงพยาบาลสมเด็จพระพุทธเลิศหล้า`,
                    autoFilter: true,
                    exportOptions: {
