...
namespace App\Http\Livewire\NoserialPlan;
...
class CreateNoserialPlan extends Component
{
    public $Plan_DATE,
        $Plan_YEAR,
        $Plan_TYPE_ID,
    ...
    {
        $EQUIPMENT_TYPE = DB::table('EQUIPMENT_TYPE')->where('TYPE_ID', 29)->get();
        $DimBudget = DB::table('DimBudget')->get();
        return view(
            'livewire.noserialPlan.create',
            [
