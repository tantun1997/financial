...
namespace App\Http\Livewire\ReplacementPlan;
...
class CreateReplacementPlan extends Component
{
    public $Plan_DATE,
        $Plan_YEAR,
        $Plan_TYPE_ID,
    ...
    {
        $EQUIPMENT_TYPE = DB::table('EQUIPMENT_TYPE')->where('TYPE_ID', 28)->get();
        $DimBudget = DB::table('DimBudget')->get();

        return view('livewire.replacementPlan.create', [
